    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
      ...
      if(logobj!=null)
      {
       ...
       if(result==true)
       {
             ...
             obj=new Email(staffobj.getEmailId(),password,"Forget Password :Password Reset Successfully from EMS","User Id="+user_id+" Your Password for EMS Login is="+password);
